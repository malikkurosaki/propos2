...
class OutletMultiSelectByCompany extends StatelessWidget {
  OutletMultiSelectByCompany({Key? key, required this.companyId, required this.onSelectOutlet}) : super(key: key);
  final _lsOutlet = [].obs;
  final _lsValue = [].obs;
          ...
          children: [
            Ink(
              ...
              child: ListTile(
                ...
                trailing: _lsOutlet.isEmpty
                    ? null
                    : Checkbox(
                        value: _lsValue.length.isEqual(_lsOutlet.length),
                        onChanged: (value) {
                          if (value!) {
